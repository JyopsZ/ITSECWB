...
router.get('/labtechView/LsearchOtherProfile',isAuthenticated, isLabTechnician, function(req, res) {
...
router.get('/labtechView/LsearchEditProfile',isAuthenticated, isLabTechnician, function(req, res) {
